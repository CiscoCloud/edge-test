...
type LogLine struct {
	...
	Timings          []*LogLine_Timing `protobuf:"bytes,5,rep,name=timings" json:"timings,omitempty"`
	XXX_unrecognized []byte            `json:"-"`
}

func (m *LogLine) Reset()         { *m = LogLine{} }
func (m *LogLine) String() string { return proto1.CompactTextString(m) }
...
func (m *LogLine) GetTimings() []*LogLine_Timing {
	if m != nil {
		return m.Timings
	}
	return nil
...
func (m *LogLine_Tag) String() string { return proto1.CompactTextString(m) }
...
func (m *LogLine_Timing) Reset()         { *m = LogLine_Timing{} }
...
func (m *LogLine_Timing) GetValue() int64 {
	if m != nil && m.Value != nil {
		return *m.Value
	}
	return 0
